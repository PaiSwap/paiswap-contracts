...
import "../paiswap/interfaces/IPaiSwapRouter.sol";
import "../paiswap/interfaces/IERC20.sol";
import "../paiswap/interfaces/IWETH.sol";
import "../paiswap/interfaces/IPaiSwapFactory.sol";
import "../paiswap/interfaces/IPaiSwapPair.sol";
import "../paiswap/libraries/SafeMath.sol";

contract PaiSwapBatchTrade {
    using SafeMath for uint256;
    IPaiSwapFactory public factory = IPaiSwapFactory(0x75e48C954594d64ef9613AeEF97Ad85370F13807);
    IPaiSwapRouter public router = IPaiSwapRouter(0x9C578b573EdE001b95d51a55A3FAfb45f5608b1f);
    address public weth = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;

    // constructor(address _router, address _weth, address _factory) public {
    //     router = IPaiSwapRouter(_router);
    //     weth = _weth;
    //     factory = IPaiSwapFactory(_factory);
    // }
        ...
        )
    {
        ...
        address stoken = IPaiSwapPair(pair).stoken();
